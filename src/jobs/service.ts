...
/**
 * HARD RAIL (Taylor, 2026-08-09: "i dont want my linkedin to be banned"): automation
...
function renderApprovalBody(draft: JobApplicationDraft): string {
  ...
  return [
    ...
    missing,
    "",
    "Submitting this application requires Taylor's explicit approval.",
  ].join("\n");
}
