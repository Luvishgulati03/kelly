 ...
 * The owner's DM bridge — so the fetch itself moved here and the modules became CONSUMERS.
 ...
 * seconds pass), so a reply starts the moment the owner hits send instead of waiting for the
