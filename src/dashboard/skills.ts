 ...
 *
 * A skill's body is authored by the owner and injected as GUIDANCE, wrapped in a header
 ...
 * the owner's own operating guidance for this turn and restates the outbound rail, so
...
export function skillGuidanceBlock(skill: LoadedSkill): string {
  return [
    ...
    "The owner selected this playbook for this turn. Follow it as operating guidance for how to answer.",
