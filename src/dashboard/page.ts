...
<div class="wrap"><div class="shell">
  ...
  <div class="pane" id="pane-voice">
    ...
    <div class="card" style="margin-bottom:12px"><h3>Counter mode</h3>
      <div class="settings">
        <label>Counter mode: <select class="input" id="set-counter-mode"><option value="review">review</option><option value="conversation">conversation</option></select></label>
        <div style="grid-column:1/-1;font-size:12px;color:var(--ink-3)">conversation sends transcripts to Kelly without review and speaks replies.</div>
